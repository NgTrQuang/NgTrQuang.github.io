    ...
    BookService.createBook(data)
      .then((response) => {
        ...
        this.setState({
          ...
          description: response.data.photo,
          published: response.data.price,
        ...
        <div className="row">
          <div className="submit-form">
            ...
            {/* <form>
                                    <div className = 'form-group'>
                                        <label> Name </label> 
                                        <input placeholder = 'Name Book' name = 'name' className = 'form-control'
                                            value = { this.state.name } onChange = { this.changeNameHandler }/>
                                    </div>
                                    <div className = 'form-group'>
                                        <label> Photo </label>
                                        <input type="file" name = 'photo' accept='/images/' className = 'form-control-file'
